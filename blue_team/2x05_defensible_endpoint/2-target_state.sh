...
#
# SYNOPSIS
#   Generates the machine-readable target state declaration for the capstone.
#
# DESCRIPTION
#   Capstone task T2 - Defensible Endpoint Package
#   Emits capstone/target_state.json declaring all validation controls.
#
# EXIT CODES
#   0 = Success
#   1 = Controlled failure / existing file without --force
...
readonly JSON_FILE="${CAPSTONE_DIR}/target_state.json"
...
validate_environment() {
    ...
    if ! command -v python3 >/dev/null 2>&1; then
        log_error "python3 is required to generate the structured JSON payload."
        exit 2
    fi
...
ensure_directories() {
    ...
    mkdir -p "$CAPSTONE_DIR" || {
        log_error "Failed to create directory: $CAPSTONE_DIR"
        exit 2
    }
}
...
check_existing_file() {
    if [[ -f "$JSON_FILE" && "$FORCE_OVERWRITE" = false ]]; then
        log_error "Target state file already exists at $JSON_FILE. Use --force to overwrite."
        exit 1
    fi
}

generate_target_state_json() {
    log_info "Generating $JSON_FILE..."
  ...
  "controls": [
    {
      ...
      "platform": "linux",
      "family": "hardening",
      "description": "SSH PermitRootLogin must be set to no",
    ...
    },
    {
      ...
      "platform": "linux",
      "family": "hardening",
      "description": "SSH PasswordAuthentication must be set to no",
      "check_type": "grep_match",
      "check_target": "/etc/ssh/sshd_config",
    ...
    },
    {
      ...
      "check_target": "net.ipv4.ip_forward",
      "expected_value": 0,
      "source_project": "2x05_defensible_endpoint",
      "severity": "medium"
    },
    {
      ...
      "platform": "linux",
      "family": "hardening",
      "description": "sysctl kernel.randomize_va_space must be 2",
      "check_type": "json_field_equals",
      "check_target": "kernel.randomize_va_space",
      "expected_value": 2,
      "source_project": "2x05_defensible_endpoint",
      "severity": "high"
    },
    ...
    },
    {
      ...
      "platform": "linux",
      "family": "hardening",
      "description": "apparmor must run in enforce mode",
      "check_type": "command_exit_zero",
    ...
    },
    {
      ...
      "check_type": "json_field_equals",
      "check_target": "DefaultInboundAction",
    ...
    },
    {
      ...
      "check_type": "json_field_equals",
      "check_target": "EnableScriptBlockLogging",
      "expected_value": 1,
      "source_project": "2x05_defensible_endpoint",
      "severity": "high"
    },
    {
      ...
      "check_type": "command_exit_zero",
      "check_target": "(Get-Service Sysmon).Status -eq 'Running'",
    ...
    },
    {
      ...
      "check_type": "file_exists",
      "check_target": "capstone/intake/intake_linux.json",
      "expected_value": True,
      "source_project": "2x05_defensible_endpoint",
      "severity": "low"
    },
    {
      ...
      "check_type": "json_field_gte",
      "check_target": "sysmon_event_count_10m",
      "expected_value": 1,
      "source_project": "2x05_defensible_endpoint",
      "severity": "medium"
    },
    {
      ...
      "check_type": "json_field_gte",
      "check_target": "script_block_channel_size",
      "expected_value": 1,
      "source_project": "2x05_defensible_endpoint",
      "severity": "medium"
    },
    ...
    },
    {
      ...
      "check_type": "json_field_equals",
      "check_target": "failed_entries_count",
      "expected_value": 0,
      "source_project": "2x05_defensible_endpoint",
      "severity": "critical"
    },
    ...
    },
    {
      ...
      "check_type": "json_field_gte",
      "check_target": "suricata_rule_count",
      "expected_value": 6,
      "source_project": "2x05_defensible_endpoint",
      "severity": "medium"
    },
    ...
    },
    {
      ...
      "check_type": "command_exit_zero",
      "check_target": "systemctl is-active pihole || systemctl is-active unbound",
      "expected_value": "active",
      "source_project": "2x05_defensible_endpoint",
      "severity": "high"
    },
    ...
    },
    {
      ...
      "check_type": "file_exists",
      "check_target": "capstone/handoff/runbook.sh",
      "expected_value": True,
      "source_project": "2x05_defensible_endpoint",
      "severity": "high"
    }
...
EOF
    ...
    log_info "Target state definition successfully written to $JSON_FILE"
}

main() {
    log_info "Starting target state generation..."
    validate_environment
    ensure_directories
    check_existing_file
    generate_target_state_json
    log_info "Target state generation completed successfully."
    exit 0
}
